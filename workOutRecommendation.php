...
$selectWorkoutSql = 'SELECT * FROM workouts_recom order by id DESC';
$selectWorkoutResult = runQuery($selectWorkoutSql);
...
<main>
    ...
    <section class="breadcrumb d-flex align-items-center justify-center">
        <div class="container"><h1 class="title capitalize pb-5 text-center fs-r-36 fw-700 line-normal"> Workout
                Recommendation </h1>
            <ul class="d-flex align-items-center justify-center">
                <li class="linkPage">Workout Recommendation</li>
    ...
    <section class="recommend overflow-hidden ">
        <div class="mainHeading text-center"><h2 class="fs-r-48 capitalize"> Workout Recommendation </h2></div>
        <div class="container">
            <div class="d-grid grid-system">
                <?php
                if ($selectWorkoutResult->num_rows > 0) {
                    while ($row = $selectWorkoutResult->fetch_assoc()) {
                        ?>
